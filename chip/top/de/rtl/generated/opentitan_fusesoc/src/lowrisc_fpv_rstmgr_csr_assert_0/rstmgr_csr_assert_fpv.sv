...
`define REGWEN_PATH rstmgr.u_reg

// Block: rstmgr
module rstmgr_csr_assert_fpv import tlul_pkg::*;
    import top_pkg::*;(
  input clk_i,
  input rst_ni,
...
`ifndef SYNTHESIS
  ...
  assign regwen[9] = 1;
  assign regwen[10] = 1;
  assign regwen[11] = `REGWEN_PATH.sw_rst_regwen_0_qs;
  assign regwen[12] = `REGWEN_PATH.sw_rst_regwen_1_qs;
  assign regwen[13] = `REGWEN_PATH.sw_rst_regwen_2_qs;
  assign regwen[14] = `REGWEN_PATH.sw_rst_regwen_3_qs;
  assign regwen[15] = `REGWEN_PATH.sw_rst_regwen_4_qs;
  assign regwen[16] = `REGWEN_PATH.sw_rst_regwen_5_qs;
  assign regwen[17] = `REGWEN_PATH.sw_rst_regwen_6_qs;
  assign regwen[18] = `REGWEN_PATH.sw_rst_regwen_7_qs;
  assign regwen[19] = 1;
  ...
  fpv_reg_access_e access_policy [20];
  ...
  always_ff @(negedge clk_i or negedge rst_ni) begin
    if (!rst_ni) begin
       ...
       exp_vals[2] <= 'h1;
       access_policy[2] <= FpvRw0c;
       exp_vals[3] <= 'h1;
       access_policy[3] <= FpvRw0c;
       exp_vals[4] <= 'h1;
       access_policy[4] <= FpvRw0c;
       exp_vals[5] <= 'h1;
       access_policy[5] <= FpvRw0c;
       exp_vals[6] <= 'h1;
       access_policy[6] <= FpvRw0c;
       exp_vals[7] <= 'h1;
       access_policy[7] <= FpvRw0c;
       exp_vals[8] <= 'h1;
       access_policy[8] <= FpvRw0c;
       exp_vals[9] <= 'h1;
       access_policy[9] <= FpvRw0c;
       exp_vals[10] <= 'h1;
       access_policy[10] <= FpvRw0c;
       exp_vals[11] <= 'h1;
      ...
      if (h2d.a_valid && d2h.a_ready) begin
        if ((normalized_addr inside {[0:108]})
           ) begin
  ...
  `ASSERT(alert_regwen_rd_A,
          (d2h.d_valid && pend_trans[d_source_idx].rd_pending &&
           pend_trans[d_source_idx].addr == 7'hc) |->
          (d2h.d_error ||
           (d2h.d_data & 'h1) ==
            (exp_vals[1] & 'h1)))
  `ASSERT(cpu_regwen_rd_A,
          (d2h.d_valid && pend_trans[d_source_idx].rd_pending &&
           pend_trans[d_source_idx].addr == 7'h1c) |->
          (d2h.d_error ||
           (d2h.d_data & 'h1) ==
            (exp_vals[2] & 'h1)))
  `ASSERT(sw_rst_regwen_0_rd_A,
          (d2h.d_valid && pend_trans[d_source_idx].rd_pending &&
           pend_trans[d_source_idx].addr == 7'h2c) |->
          (d2h.d_error ||
           (d2h.d_data & 'h1) ==
            (exp_vals[3] & 'h1)))
  `ASSERT(sw_rst_regwen_1_rd_A,
          (d2h.d_valid && pend_trans[d_source_idx].rd_pending &&
           pend_trans[d_source_idx].addr == 7'h30) |->
          (d2h.d_error ||
           (d2h.d_data & 'h1) ==
            (exp_vals[4] & 'h1)))
  `ASSERT(sw_rst_regwen_2_rd_A,
          (d2h.d_valid && pend_trans[d_source_idx].rd_pending &&
           pend_trans[d_source_idx].addr == 7'h34) |->
          (d2h.d_error ||
           (d2h.d_data & 'h1) ==
            (exp_vals[5] & 'h1)))
  `ASSERT(sw_rst_regwen_3_rd_A,
          (d2h.d_valid && pend_trans[d_source_idx].rd_pending &&
           pend_trans[d_source_idx].addr == 7'h38) |->
          (d2h.d_error ||
           (d2h.d_data & 'h1) ==
            (exp_vals[6] & 'h1)))
  `ASSERT(sw_rst_regwen_4_rd_A,
          (d2h.d_valid && pend_trans[d_source_idx].rd_pending &&
           pend_trans[d_source_idx].addr == 7'h3c) |->
          (d2h.d_error ||
           (d2h.d_data & 'h1) ==
            (exp_vals[7] & 'h1)))
  `ASSERT(sw_rst_regwen_5_rd_A,
          (d2h.d_valid && pend_trans[d_source_idx].rd_pending &&
           pend_trans[d_source_idx].addr == 7'h40) |->
          (d2h.d_error ||
           (d2h.d_data & 'h1) ==
            (exp_vals[8] & 'h1)))
  `ASSERT(sw_rst_regwen_6_rd_A,
          (d2h.d_valid && pend_trans[d_source_idx].rd_pending &&
           pend_trans[d_source_idx].addr == 7'h44) |->
          (d2h.d_error ||
           (d2h.d_data & 'h1) ==
            (exp_vals[9] & 'h1)))
  `ASSERT(sw_rst_regwen_7_rd_A,
          (d2h.d_valid && pend_trans[d_source_idx].rd_pending &&
           pend_trans[d_source_idx].addr == 7'h48) |->
          (d2h.d_error ||
           (d2h.d_data & 'h1) ==
            (exp_vals[10] & 'h1)))
  `ASSERT(sw_rst_ctrl_n_0_rd_A,
          (d2h.d_valid && pend_trans[d_source_idx].rd_pending &&
           pend_trans[d_source_idx].addr == 7'h4c) |->
          (d2h.d_error ||
           (d2h.d_data & 'h1) ==
            (exp_vals[11] & 'h1)))
  `ASSERT(sw_rst_ctrl_n_1_rd_A,
          (d2h.d_valid && pend_trans[d_source_idx].rd_pending &&
           pend_trans[d_source_idx].addr == 7'h50) |->
          (d2h.d_error ||
           (d2h.d_data & 'h1) ==
            (exp_vals[12] & 'h1)))
  `ASSERT(sw_rst_ctrl_n_2_rd_A,
          (d2h.d_valid && pend_trans[d_source_idx].rd_pending &&
           pend_trans[d_source_idx].addr == 7'h54) |->
          (d2h.d_error ||
           (d2h.d_data & 'h1) ==
            (exp_vals[13] & 'h1)))
  `ASSERT(sw_rst_ctrl_n_3_rd_A,
          (d2h.d_valid && pend_trans[d_source_idx].rd_pending &&
           pend_trans[d_source_idx].addr == 7'h58) |->
          (d2h.d_error ||
           (d2h.d_data & 'h1) ==
            (exp_vals[14] & 'h1)))
  `ASSERT(sw_rst_ctrl_n_4_rd_A,
          (d2h.d_valid && pend_trans[d_source_idx].rd_pending &&
           pend_trans[d_source_idx].addr == 7'h5c) |->
          (d2h.d_error ||
           (d2h.d_data & 'h1) ==
            (exp_vals[15] & 'h1)))
  `ASSERT(sw_rst_ctrl_n_5_rd_A,
          (d2h.d_valid && pend_trans[d_source_idx].rd_pending &&
           pend_trans[d_source_idx].addr == 7'h60) |->
          (d2h.d_error ||
           (d2h.d_data & 'h1) ==
            (exp_vals[16] & 'h1)))
  `ASSERT(sw_rst_ctrl_n_6_rd_A,
          (d2h.d_valid && pend_trans[d_source_idx].rd_pending &&
           pend_trans[d_source_idx].addr == 7'h64) |->
          (d2h.d_error ||
           (d2h.d_data & 'h1) ==
            (exp_vals[17] & 'h1)))
  `ASSERT(sw_rst_ctrl_n_7_rd_A,
          (d2h.d_valid && pend_trans[d_source_idx].rd_pending &&
           pend_trans[d_source_idx].addr == 7'h68) |->
          (d2h.d_error ||
           (d2h.d_data & 'h1) ==
            (exp_vals[18] & 'h1)))
