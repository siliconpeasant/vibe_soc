# bus - RTL Filelist Dependencies
# 用法: 在其他 Makefile 中 include $(PROJECT_ROOT)/.../de/rtl/filelist.mk

ifndef BUS_FILELIST_MK
BUS_FILELIST_MK := 1

# 本模块 RTL filelist（自动推导当前目录）
BUS_FILELIST := $(dir $(realpath $(lastword $(MAKEFILE_LIST))))filelist.f
...
ifeq (,$(filter $(BUS_FILELIST),$(MODULE_FILELISTS)))
  MODULE_FILELISTS += $(BUS_FILELIST)
endif
