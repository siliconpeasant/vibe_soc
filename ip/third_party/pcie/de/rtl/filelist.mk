# pcie - RTL Filelist Dependencies
# 用法: 在其他 Makefile 中 include $(PROJECT_ROOT)/.../de/rtl/filelist.mk

ifndef PCIE_FILELIST_MK
PCIE_FILELIST_MK := 1

# 本模块 RTL filelist（自动推导当前目录）
PCIE_FILELIST := $(dir $(realpath $(lastword $(MAKEFILE_LIST))))filelist.f
...
ifeq (,$(filter $(PCIE_FILELIST),$(MODULE_FILELISTS)))
  MODULE_FILELISTS += $(PCIE_FILELIST)
endif
