# spi - RTL Filelist Dependencies
# 用法: 在其他 Makefile 中 include $(PROJECT_ROOT)/.../de/rtl/filelist.mk

ifndef SPI_FILELIST_MK
SPI_FILELIST_MK := 1

# 本模块 RTL filelist（自动推导当前目录）
SPI_FILELIST := $(dir $(realpath $(lastword $(MAKEFILE_LIST))))filelist.f
...
ifeq (,$(filter $(SPI_FILELIST),$(MODULE_FILELISTS)))
  MODULE_FILELISTS += $(SPI_FILELIST)
endif
