# npu - RTL Filelist Dependencies
# 用法: 在其他 Makefile 中 include $(PROJECT_ROOT)/.../de/rtl/filelist.mk

ifndef NPU_FILELIST_MK
NPU_FILELIST_MK := 1

# 本模块 RTL filelist（自动推导当前目录）
NPU_FILELIST := $(dir $(realpath $(lastword $(MAKEFILE_LIST))))filelist.f
...
ifeq (,$(filter $(NPU_FILELIST),$(MODULE_FILELISTS)))
  MODULE_FILELISTS += $(NPU_FILELIST)
endif
