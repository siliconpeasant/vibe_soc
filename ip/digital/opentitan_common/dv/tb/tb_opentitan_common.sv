...
module tb_opentitan_common;
    ...
    initial begin
        ...
        $dumpvars(0, tb_opentitan_common);
    end
    ...
    initial begin
        $display("==================================");
        $display(" opentitan_common IP Simulation Start ");
        $display("==================================");
        ...
        $display(" opentitan_common IP Simulation Done  ");
        $display("==================================");
        $finish;
    end
