...
module tb_template_ip;
    ...
    initial begin
        $display("==================================");
        $display(" template_ip IP Simulation Start ");
        $display("==================================");
        ...
        $display(" template_ip IP Simulation Done  ");
        $display("==================================");
        $finish;
    end
